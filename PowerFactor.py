...
print("Xl = ",str(XofL) + "-90 degrees")
print("Z Total =", str(zTotalReal_1) + " ohms " + str(zTotalDeg_1) + " degrees")
print("I Total =",str(UnCorI) + " " + str(UnCorIang) + " degrees")
...
print("Xc =", str(XofC) + " -90 degrees")
print("C =", str(Cvalue)+"F")
print("Capacitor Value =", str((Cvalue * math.pow(10, 6))) + "uF")

# -- Corrected Values --
print("")
print("Corrected Values:")
print("Z Total =", str(ZtotalMagCorrect) + " " + str(ZtotalAngCorrect) + " degrees")
print("I Total =", str(CorrectI) + " " + str(CorrectIang) + " degrees")
